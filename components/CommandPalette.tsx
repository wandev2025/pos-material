                          ...
                          {keepOpenOnSelect && getCount ? (
                            count > 0 ? (
                              <View style={styles.stepper}>
                                <TouchableOpacity onPress={() => onRemove?.(item)} style={styles.stepBtn}>
                                  <Ionicons name="remove" size={16} color="#DC2626" />
                                </TouchableOpacity>
                                <Text style={styles.stepCount}>{count}</Text>
                                <TouchableOpacity onPress={() => pick(item)} style={styles.stepBtn}>
                                  <Ionicons name="add" size={16} color="#16A34A" />
                                </TouchableOpacity>
                              </View>
                            ) : (
                              <TouchableOpacity onPress={() => pick(item)} style={{ paddingLeft: 8 }}>
                            ...
                            <>
                              ...
                              <Ionicons
                                name={keepOpenOnSelect ? 'add-circle' : 'chevron-forward'}
                                size={keepOpenOnSelect ? 24 : 18}
                                color={keepOpenOnSelect ? '#DC2626' : '#CBD5E1'}
                              />
                            </>
                          )}
                        </View>
