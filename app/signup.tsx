    ...
    <>
      ...
      <View style={styles.inputWrapper}>
        ...
        <View style={styles.inputContainer}>
          ...
          <TextInput style={styles.input} placeholder="Nama lengkap" placeholderTextColor="#9CA3AF" value={fullName} onChangeText={setFullName} />
        </View>
      </View>
          ...
          >
            ...
            <View style={styles.brandContent}>
              ...
              <Text style={styles.brandSub}>
                Buat akun manajemen untuk mulai mengelola toko material Anda.
              </Text>
            </View>
          </LinearGradient>
        )}
